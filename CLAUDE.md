...
**Jamais de mention « Generated by/with Claude Code » (ni « 🤖 Generated with Claude Code »)** dans les messages de commit, les descriptions de PR ou les issues. Si l'outil en ajoute une automatiquement (footer de PR), la retirer. Supprimer aussi toute mention existante rencontrée.
