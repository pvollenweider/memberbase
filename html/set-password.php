<?php
/**
 * set-password.php — Token-based password setup for new users.
 * Public page (no login required). Token generated by admin on user creation.
 */
...
<head>
  ...
  <title>Définir mon mot de passe — Casa Alianza</title>
...
<div class="card shadow-sm border-0" style="max-width:400px;width:100%">
  <div class="card-body p-4">
    <h5 class="mb-4">Casa Alianza — Définir mon mot de passe</h5>
