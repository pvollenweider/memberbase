...
while ($row = $stmt->fetchObject()) {
    ...
    <tr class="ca-row-link" data-href="<?=$_SERVER['PHP_SELF']?>?view=compta&userid=<?=(int)$userId?>" style="cursor:pointer;">
        ...
        <td>
            <a href="<?=$_SERVER['PHP_SELF']?>?view=compta&amp;userid=<?=(int)$userId?>"
