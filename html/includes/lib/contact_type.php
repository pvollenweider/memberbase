<?php
/**
 * Contact type management (issue #165) — private donor vs institution vs
 * financial institution vs company. Backed by the `contact_type` lookup
 * table (id, code, label): `code` is a stable unique key (never used for
 * logic beyond the 4 built-in rows), `label` is admin-editable.
 *
