        ...
        <tr id="row-<?= $ct->id ?>" draggable="true" data-id="<?= $ct->id ?>" class="<?= $ct->is_archived ? 'opacity-50' : '' ?>">
          ...
          <td class="text-center">
            <form method="post" action="<?= appUrl() ?>">
              ...
              <input type="hidden" name="is_excluded_from_donation" value="<?= $ct->is_excluded_from_donation ?>">
              <input type="hidden" name="is_institutional" value="<?= $ct->is_institutional ?>">
              <input type="hidden" name="is_financial_institution" value="<?= $ct->is_financial_institution ? 0 : 1 ?>">
              <button type="submit" class="btn btn-sm p-0 border-0 bg-transparent"
                      title="<?= $ct->is_financial_institution ? $GLOBAL['yesClickToDisable'] : $GLOBAL['noClickToEnable'] ?>">
                <i class="fas <?= $ct->is_financial_institution ? 'fa-check-circle text-primary' : 'fa-circle text-muted' ?>"></i>
              </button>
            </form>
          </td>
          <td class="text-center">
            <form method="post" action="<?= appUrl() ?>">
              ...
              <input type="hidden" name="is_excluded_from_donation" value="<?= $ct->is_excluded_from_donation ?>">
              <input type="hidden" name="is_institutional" value="<?= $ct->is_institutional ?>">
              <input type="hidden" name="is_company" value="<?= $ct->is_company ? 0 : 1 ?>">
              <button type="submit" class="btn btn-sm p-0 border-0 bg-transparent"
                      title="<?= $ct->is_company ? $GLOBAL['yesClickToDisable'] : $GLOBAL['noClickToEnable'] ?>">
                <i class="fas <?= $ct->is_company ? 'fa-check-circle text-secondary' : 'fa-circle text-muted' ?>"></i>
              </button>
            </form>
          </td>
          <td class="text-center">
