...
$GLOBAL['contactTypesHelp']          = "Suggests a contact type (private donor, institution, financial institution, company) for each active contact, based on their linked accounting entry types and the Society field. Nothing is applied without confirming below.";
$GLOBAL['contactTypesAppliedMsg']    = "%d contact(s) updated.";
$GLOBAL['contactTypesNoFlaggedTypes'] = "No accounting type is flagged \"institutional\", \"financial institution\" or \"company\" — configure them in";
$GLOBAL['contactTypesNoDiffs']       = "All contacts already have the suggested type.";
$GLOBAL['contactTypesDiffCount']     = "%d contact(s) with a different suggested type";
$GLOBAL['contactTypesApplySelection'] = "Apply selection";
$GLOBAL['contactTypeCurrent']        = "Current type";
$GLOBAL['contactTypeSuggested']      = "Suggested type";
$GLOBAL['contactTypesClassifyTitle'] = "Classification suggestion";
