...
$GLOBAL['neverPaidOld']            = "Created over 3 years ago, never paid anything";
$GLOBAL['cotiPaid6Years']          = "Cotisation paid since " . (date('Y') - 5);
$GLOBAL['nonInstitPayedSomethingLastYear'] = "Non-institutional donor active in " . (date('Y') - 1);
$GLOBAL['nonInstitPayed5Years']    = "Non-institutional donor active since " . (date('Y') - 5);
...
$GLOBAL['save']            = "Save";
$GLOBAL['saved']           = "Saved.";
$GLOBAL['segmentModified']   = "Segment modified.";
...
$GLOBAL['editSegment']            = "Edit segment";
...
$GLOBAL['dashboardCotisationsLabel'] = "Membership fees";
$GLOBAL['dashboardDonationBreakdownTitle'] = "Donation breakdown";
$GLOBAL['dashboardContactBreakdownTitle'] = "Donations by contact type";
...
$GLOBAL['suiviActivityListTitle'] = "Recent activity";
$GLOBAL['dashboardRecentSegmentsTitle'] = "Recently viewed segments";
...
$GLOBAL['segmentCascadeRules']       = "Auto-assignment rules";
$GLOBAL['segmentCascadeRulesHint']   = "Adding a member to the source segment also automatically adds them to the target segment.";
$GLOBAL['segmentCascadeSourceLabel'] = "Source segment…";
$GLOBAL['segmentCascadeTargetLabel'] = "Target segment…";
$GLOBAL['cascadeRuleMissingTitle']  = "Auto-assignment rules not applied";
$GLOBAL['cascadeRuleMissingHelp']   = "These members are in a rule's source segment but not yet in the target segment (assignment predates the rule, or an import bypassed individual assignment).";
$GLOBAL['cascadeRuleSourceColumn']  = "Source segment";
$GLOBAL['cascadeRuleTargetColumn']  = "Target segment";
$GLOBAL['cascadeRuleApplyFix']      = "Apply";
$GLOBAL['cotiSegmentMissingTitle']  = "Cotisation payers missing from their year's segment";
$GLOBAL['cotiSegmentMissingHelp']   = "These members paid a cotisation for the year shown but aren't in the matching \"Member <year>\" segment (backfilled/imported entry predating the automatic add, or removed from the segment since). Limited to the last 3 years.";
$GLOBAL['toggleSidebar']      = "Toggle menu";
$GLOBAL['tasks']              = "Tasks";
$GLOBAL['tasksPageTitle']     = "Tasks";
$GLOBAL['taskTitle']          = "Title";
$GLOBAL['taskAddNew']         = "Add a task";
$GLOBAL['taskBody']           = "Description";
$GLOBAL['dueDate']            = "Due date";
$GLOBAL['priority']           = "Priority";
$GLOBAL['taskPriorityHigh']   = "High";
$GLOBAL['taskPriorityNormal'] = "Normal";
$GLOBAL['taskPriorityLow']    = "Low";
$GLOBAL['taskOpen']           = "Open";
$GLOBAL['taskDone']           = "Done";
$GLOBAL['taskOverdue']        = "Overdue";
$GLOBAL['taskMarkDone']       = "Mark as done";
$GLOBAL['taskMarkDoneRecap']  = "Mark as notified without sending an email (entries marked notified)";
$GLOBAL['reopen']             = "Reopen";
$GLOBAL['noTasks']            = "No tasks.";
$GLOBAL['noOpenTasks']        = "No open tasks.";
$GLOBAL['globalTask']         = "General task";
$GLOBAL['updateTask']         = "Update";
...
$GLOBAL['taskGenerateRecapBtn']    = "Generate payment notification tasks";
$GLOBAL['taskRuleComptaRecapTitle'] = "Pending payment notification %d";
$GLOBAL['sendRecapBtnOne']         = "Send notification";
$GLOBAL['sendRecapSending']        = "Sending...";
$GLOBAL['sendRecapConfirmOne']     = "Send the payment notification to %s?";
$GLOBAL['sendRecapSentFail']       = "Send failed";
$GLOBAL['taskCompletedTitle']      = "%d completed task(s)";
$GLOBAL['taskBulkDeleteBtn']       = "Delete completed tasks";
$GLOBAL['taskBulkDeleteConfirm']   = "Permanently delete %d completed task(s)? This cannot be undone.";
$GLOBAL['taskBulkDeletedCount']    = "%d completed task(s) deleted.";
$GLOBAL['taskPause']               = "Pause";
$GLOBAL['taskResume']              = "Resume";
$GLOBAL['taskPausedStatus']        = "Paused";
$GLOBAL['taskPausedTitle']         = "%d paused task(s)";
...
$GLOBAL['taskRuleAttestationTitle']   = "Donation attestation %d to send";
$GLOBAL['sendAttestationBtnOne']      = "Send attestation";
$GLOBAL['sendAttestationSending']     = "Sending...";
$GLOBAL['sendAttestationConfirmOne']  = "Send the donation attestation to %s?";
$GLOBAL['sendAttestationSentFail']    = "Send failed";
$GLOBAL['dashboardPageTitle']      = "Dashboard";
$GLOBAL['dashboardTasksTitle']     = "Tasks to handle";
$GLOBAL['dashboardOpenTaskCount']  = "%d open task(s)";
$GLOBAL['dashboardViewAllTasks']   = "View all tasks";
$GLOBAL['dashboardKpiTitle']       = "At a glance";
$GLOBAL['dashboardShortcutsTitle'] = "Shortcuts";
$GLOBAL['dashboardRecentComptaTitle'] = "Latest entries";
$GLOBAL['seeAllEntries'] = "See all entries";
$GLOBAL['dashboardRecentContactsTitle'] = "Latest contacts created";
$GLOBAL['dashboardShortcutNewDonors']    = "New donors";
$GLOBAL['newSinceLastYear']              = "New";
$GLOBAL['vsSamePeriodRange']             = "vs %1\$s 1 – %3\$s %2\$d, %4\$d";
$GLOBAL['dashboardShortcutLapsedDonors'] = "Lapsed donors";
$GLOBAL['dashboardShortcutNewMembers']   = "New members";
$GLOBAL['dashboardShortcutLastYearMembers'] = "Last year's members";
$GLOBAL['dashboardShortcutAttestations'] = "Tax receipts to send";
$GLOBAL['dashboardShortcutCurrentMembers'] = "Current members";
$GLOBAL['dashboardToRelaunchSuffix'] = "to follow up";
$GLOBAL['dashboardUserGuideLink']  = "User guide";
$GLOBAL['dashboardAdminGuideLink'] = "Admin guide";
$GLOBAL['peopleFinancePageTitle']  = "Contacts";
$GLOBAL['financesPageTitle'] = "Finances";
$GLOBAL['peopleFinanceTabMembers'] = "Contacts";
$GLOBAL['peopleFinanceMembersSubtitle'] = "List & segments";
$GLOBAL['filterBySegment'] = "Filter by segment";
$GLOBAL['viewAllCurrentMembers'] = "View all current members";
$GLOBAL['peopleFinanceTabRecap']   = "Payment notification";
$GLOBAL['peopleFinanceTabLapsed']  = "Member movements";
$GLOBAL['peopleFinanceTabLapsedDonors'] = "Donor movements";
$GLOBAL['peopleFinanceTabDons']    = "Attestation";
$GLOBAL['peopleFinanceGroupFinances']  = "Finances";
$GLOBAL['peopleFinanceGroupEvolution'] = "Evolution";
$GLOBAL['adminGroupSegments']    = "Segments";
$GLOBAL['adminGroupApplication'] = "Application";
$GLOBAL['adminGroupDiagnostics'] = "Diagnostics";
$GLOBAL['peopleFinanceComingSoon'] = "This section isn't integrated here yet — it still lives on its own page.";
$GLOBAL['peopleFinanceOpenLegacy'] = "Open";
$GLOBAL['dashboardComptaSearchLabel']       = "Search a contact to add an accounting entry";
$GLOBAL['dashboardComptaSearchPlaceholder'] = "Search a contact → Compta…";
$GLOBAL['dashboardComptaSearchNoResults']   = "No results";
$GLOBAL['dashboardComptaSearchOneResult']   = "1 result";
$GLOBAL['dashboardComptaSearchResultsCount'] = "%d results";
$GLOBAL['tel']             = "Home";
$GLOBAL['telProf']         = "Work";
$GLOBAL['title']           = "Title";
$GLOBAL['total']           = "Total";
...
$GLOBAL['users']               = "Users";
$GLOBAL['journal']             = "Log";
$GLOBAL['journalsPageTitle']   = "Journals";
$GLOBAL['integrity']           = "Integrity";
$GLOBAL['health']              = "Health";
$GLOBAL['contactTypesTitle']         = "Contact type";
$GLOBAL['contactTypeCode']           = "Code";
$GLOBAL['contactTypeLabel']          = "Label";
$GLOBAL['contactTypeCodeHelp']       = "Unique internal code (lowercase, digits, underscore, max 20 chars)";
$GLOBAL['contactTypeCodeBuiltinHelp'] = "Fixed code — used by the classification suggestion, not editable";
$GLOBAL['contactTypeCount']          = "Contacts";
$GLOBAL['contactTypeVisibleInAttestations']       = "Attestations";
$GLOBAL['contactTypeVisibleInAttestationsHelp']   = "When checked, contacts of this type appear in the list of attestations to send (Donations tab).";
$GLOBAL['contactTypeVisibleInAttestationsToggle'] = "Show \"%s\" contacts in the attestations list";
$GLOBAL['contactTypeVisibleInRecap']       = "Recap";
$GLOBAL['contactTypeVisibleInRecapHelp']   = "If checked, contacts of this type appear in the compta recap (Recap tab) and in the related notification tasks.";
$GLOBAL['contactTypeVisibleInRecapToggle'] = "Show \"%s\" contacts in the recap";
$GLOBAL['contactTypeIcon']           = "Icon";
$GLOBAL['contactTypeIconPlaceholder'] = "e.g. user";
$GLOBAL['contactTypeIconHelp']       = "Font Awesome icon name (without the fa- prefix), e.g. \"user\", \"landmark\", \"building\".";
$GLOBAL['contactTypeIconFaHint']     = "Find a free icon name on %s and paste it without the \"fa-\" prefix.";
$GLOBAL['newContactType']            = "New contact type";
$GLOBAL['newContactTypeHelp']        = "A type added here is never auto-suggested by the classification tool below — it can only be assigned manually, from the member fiche.";
$GLOBAL['contactTypeLabelSavedMsg']  = "Label saved.";
$GLOBAL['contactTypeFilterAll']      = "All contact types";
$GLOBAL['contactTypeMatrixTitle']    = "Allowed compta types per contact type";
$GLOBAL['contactTypeMatrixHelp']     = "Restricts which compta types are offered when creating an entry, based on the contact's type. All checked (default) = no restriction, every active type stays offered.";
$GLOBAL['contactTypeMatrixSavedMsg'] = "Matrix saved.";
$GLOBAL['contactTypeMatrixNoComptaTypes'] = "No active (non-archived) compta type to configure.";
...
$GLOBAL['oneSegmentHidden'] = "1 group hidden.";
$GLOBAL['segmentsHidden'] = "%d groups hidden.";
$GLOBAL['oneSegmentShown'] = "1 group shown.";
$GLOBAL['segmentsShown'] = "%d groups shown.";
$GLOBAL['lapsedDonorsSegmentName'] = "Donors to re-engage %d (%s)";
$GLOBAL['lapsedMembersSegmentName'] = "Members to re-engage %d (%s)";
$GLOBAL['noUsersToAdd'] = "No user to add.";
$GLOBAL['invalidData'] = "Invalid data";
$GLOBAL['segmentNotFound'] = "Group not found";
...
$GLOBAL['sumRequired'] = "Please enter an amount.";
...
$GLOBAL['backToMemberOverview'] = "Back to members & finances";
$GLOBAL['newMembersTitle'] = "New members %d";
$GLOBAL['newMembersCount'] = '<strong>%1$s new member(s)</strong> — paid a cotisation in <strong>%3$d</strong> with none in <strong>%4$d</strong>.';
$GLOBAL['newMembers'] = "New members";
...
$GLOBAL['filterBulkCount']         = "%d people in this filter.";
$GLOBAL['filterCreateSegmentBtn']  = "Create a segment";
$GLOBAL['filterAddToSegmentBtn']   = "Add to an existing segment";
$GLOBAL['filterArchiveBtn']        = "Bulk archive";
$GLOBAL['confirmCreateFilterSegment'] = "Create a segment with these <strong>%d</strong> people?";
$GLOBAL['confirmAddFilterToSegment']  = "Add these <strong>%d</strong> people to the chosen segment:";
$GLOBAL['chooseSegment']              = "Choose a segment…";
$GLOBAL['filterArchiveWarning']    = "Bulk action: these members will be archived (inactive status). It's reversible (one-by-one reactivation), but review the list before continuing.";
$GLOBAL['confirmArchiveFilterUsers']    = "Archive these <strong>%d</strong> member(s)?";
$GLOBAL['neverPaidSegmentName']       = "Never paid — %s";
$GLOBAL['noActivity10ySegmentName']   = "No activity 10 years — %s";
...
$GLOBAL['cotiReminderResendBtn']     = 'Resend';
$GLOBAL['cotiReminderResendConfirm'] = 'A reminder was already sent to %s on %s. Send again?';
...
$GLOBAL['gapToBudget'] = "%s CHF short of the %d budget (%s) — %s%% reached";
$GLOBAL['budgetExceeded'] = "%d budget (%s) exceeded by +%s CHF (+%s%%)";
$GLOBAL['budgetsPageTitle'] = "Budgets";
$GLOBAL['budgetsHelp'] = "One budget per accounting type and per year (last year, current, next). Amounts save automatically.";
$GLOBAL['budgetsDonationTitle'] = "Types counted as donations";
$GLOBAL['budgetsDonationHelp'] = "These types feed the budget compared against the dashboard's \"Contributions\" KPI.";
$GLOBAL['budgetsExcludedTitle'] = "Types excluded from donations";
$GLOBAL['budgetsExcludedHelp'] = "These types (e.g. membership fees) feed the budget compared against the dashboard's \"Members\" KPI.";
$GLOBAL['budgetsNoTypes'] = "No type in this category.";
$GLOBAL['budgetColYear'] = "Budget %d";
$GLOBAL['budgetColCollected'] = "Collected %d";
$GLOBAL['budgetInputLabel'] = "%s budget for %d";
$GLOBAL['budgetSavedMsg'] = "Saved";
$GLOBAL['excludedFromDonationShort'] = "excluded from donations";
...
$GLOBAL['sendAttestationsBulkOk'] = "%d attestation(s) sent, %sk skipped (no email or failure), %alr already sent (not resent).";
$GLOBAL['sendBccCopyLabel'] = "Send a copy (BCC) to %s";
$GLOBAL['bulkAttestAlreadySentIntro'] = "already received their attestation this year — check to resend (otherwise skipped):";
...
$GLOBAL['cotisantsImportNoYearSelected'] = "No year selected — nothing was imported.";
$GLOBAL['donorsImported'] = "Donors imported into the segment.";
$GLOBAL['donorsImportNoTypeSelected'] = "No donation type selected — nothing was imported. Check \"All types\" or at least one type.";
$GLOBAL['donorsImportNoYearSelected'] = "No year selected — nothing was imported. Check \"All years\" or at least one year.";
...
$GLOBAL['allDonorTypes'] = "All types";
$GLOBAL['allYears'] = "All years";
$GLOBAL['noneSelected'] = "None selected";
$GLOBAL['typesSelected'] = "types selected";
$GLOBAL['yearsSelected'] = "years selected";
...
$GLOBAL['bulkDeleteSegmentsBtn'] = "Delete";
$GLOBAL['bulkDeleteSegmentsConfirmTitle'] = "Delete these hidden segments?";
$GLOBAL['bulkDeleteSegmentsIrreversibleWarning'] = "This is irreversible: the segments and their member association history will be permanently deleted.";
$GLOBAL['bulkDeleteSegmentsMembersNote'] = "Members themselves won't be deleted — %d segment membership%s in total will be removed.";
...
$GLOBAL['memberSegmentPrefixHelp'] = 'Prefix used to find the member segments of previous years (e.g. “Member” for the segments “Member 2025”, “Member 2026”…).';
...
$GLOBAL['defaultSegmentLabel'] = "Segment displayed by default";
$GLOBAL['defaultSegmentHelp'] = "Segment selected when opening the member list. Choose the segment matching the current year's members (e.g. “Member 2026”). To be updated every year.";
$GLOBAL['maskedSuffix'] = "(hidden)";
$GLOBAL['membreSegmentLabel'] = "Member segment (reference year)";
$GLOBAL['membreSegmentHelp'] = "Member segment of the current year (e.g. “Member 2026”). Used for the membership fee filters and shown in the Contributions dashboard with a comparison to the previous year. To be updated every year.";
$GLOBAL['noCotiSegmentLabel'] = "Segment of members without membership fee";
$GLOBAL['noCotiSegmentHelp'] = "Members considered active without paying a membership fee (volunteers, committee…). Excluded from the “No membership fee in the last 3 years” filter. Leave empty if not applicable.";
...
$GLOBAL['orgTaxStatusHelp'] = "E.g. «Tax-exempt AFC-GE since 2018». Manual entry — no federal register currently exposes this.";
$GLOBAL['orgTaxStatusPlaceholder'] = "E.g. Tax-exempt AFC-GE since 2018";
$GLOBAL['orgIban'] = "IBAN";
$GLOBAL['orgIbanHelp'] = "Organisation IBAN number. Used for QR payment slips.";
$GLOBAL['orgCotiAmountDesc'] = "Amount description (cotisation reminders)";
$GLOBAL['orgCotiAmountDescHelp'] = "Text shown in the reminder email and on the QR slip (Amount field). Leave empty to use the default.";
$GLOBAL['orgCotiAmountDescPlaceholder'] = "min. CHF 50.- / pers. · CHF 80.- / family · CHF 20.- students, AVS, unemployed";
...
// --- settings_filters ---
$GLOBAL['filtersHelp'] = "Create a quick view by checking multiple segments to combine. Example: a combined segment “Members Geneva + Vaud” merges two regional segments into a single shortcut in the navigation bar — always up to date, no data copy.";
...
$GLOBAL['defaultLibeleField'] = "Default entry label";
$GLOBAL['defaultLibeleHelp'] = "Prefilled in the entry form. For a cotisation type the selected year is appended automatically (e.g. “Cotisation 2026”).";
...
$GLOBAL['financialInstTooltip'] = "Payment from a financial institution";
$GLOBAL['financialInstShort'] = "Fin. inst.";
$GLOBAL['companyTypeTooltip'] = "Payment from a company";
$GLOBAL['companyTypeShort'] = "Company";
$GLOBAL['archivedTooltip'] = "Archived type — hidden from the picker when creating a new entry, still shown on existing entries";
$GLOBAL['archivedShort'] = "Archived";
...
$GLOBAL['deleteContactTypeTitle'] = "Delete this contact type";
$GLOBAL['deleteContactTypeConfirm'] = "Delete this contact type? This action is irreversible.";
...
$GLOBAL['filterDescNeverPaidOld'] = "Active profiles created before %s with no accounting entry, ever.";
...
$GLOBAL['filterDescNonInstit5y'] = "Non-institutional profiles that made at least one non-institutional payment since January 1, %s.";
$GLOBAL['filterDescCotiPaid6y'] = "Contacts who paid at least one cotisation since January 1, %s.";
...
$GLOBAL['loadError'] = "Loading error.";
...
$GLOBAL['npaLabel'] = "NPA";
$GLOBAL['memberPrefixLabel'] = "Member segments prefix";
...
$GLOBAL['appBaseUrl']          = "Application public URL";
$GLOBAL['appBaseUrlHelp']      = "Optional. Used to turn action links in emails (e.g. the task digest) into clickable links back to the application. Without it, emails stay plain text. Example: https://members.myassociation.org";
...
$GLOBAL['comptaRecapScopeAll']       = "Include already-notified payments";
