...
$GLOBAL['neverPaidBulkCount']         = "%d people in this filter.";
$GLOBAL['neverPaidCreateSegmentBtn']  = "Create a segment";
$GLOBAL['neverPaidAddToSegmentBtn']   = "Add to an existing segment";
$GLOBAL['neverPaidArchiveBtn']        = "Bulk archive";
$GLOBAL['confirmCreateNeverPaidSegment'] = "Create a segment with these <strong>%d</strong> people?";
$GLOBAL['confirmAddNeverPaidToSegment']  = "Add these <strong>%d</strong> people to the chosen segment:";
$GLOBAL['chooseSegment']              = "Choose a segment…";
$GLOBAL['neverPaidArchiveWarning']    = "Bulk action: these members will be archived (inactive status). It's reversible (one-by-one reactivation), but review the list before continuing.";
$GLOBAL['confirmArchiveNeverPaid']    = "Archive these <strong>%d</strong> member(s)?";
