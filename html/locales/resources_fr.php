...
$GLOBAL['neverPaidBulkCount']         = "%d personne(s) dans ce filtre.";
$GLOBAL['neverPaidCreateSegmentBtn']  = "Créer un segment";
$GLOBAL['neverPaidAddToSegmentBtn']   = "Ajouter à un segment existant";
$GLOBAL['neverPaidArchiveBtn']        = "Archiver en masse";
$GLOBAL['confirmCreateNeverPaidSegment'] = "Créer un segment avec ces <strong>%d</strong> personne(s) ?";
$GLOBAL['confirmAddNeverPaidToSegment']  = "Ajouter ces <strong>%d</strong> personne(s) au segment choisi :";
$GLOBAL['chooseSegment']              = "Choisir un segment…";
$GLOBAL['neverPaidArchiveWarning']    = "Action en masse : ces membres seront archivés (statut inactif). C'est réversible (réactivation possible un par un), mais vérifiez la liste avant de continuer.";
$GLOBAL['confirmArchiveNeverPaid']    = "Archiver ces <strong>%d</strong> membre(s) ?";
