...
$GLOBAL['cotiPaid6Years']          = "Cotisation payée depuis " . (date('Y') - 5);
$GLOBAL['nonInstitPayedSomethingLastYear'] = "Donateur non institutionnel actif en " . (date('Y') - 1);
$GLOBAL['nonInstitPayed5Years']    = "Donateur non institutionnel actif depuis " . (date('Y') - 5);
...
$GLOBAL['segmentModified']   = "Segment modifié.";
...
$GLOBAL['editSegment']            = "Modifier le segment";
...
$GLOBAL['dashboardMembersLabel'] = "Membres";
$GLOBAL['dashboardCotisationsLabel'] = "Cotisations";
$GLOBAL['dashboardDonationBreakdownTitle'] = "Répartition des dons";
$GLOBAL['dashboardContactBreakdownTitle'] = "Dons par type de contact";
$GLOBAL['dashboardRevenueChartLabel'] = "Évolution cumulée des recettes, année en cours vs année précédente";
...
$GLOBAL['suiviActivityListTitle'] = "Activités récentes";
$GLOBAL['dashboardRecentSegmentsTitle'] = "Segments récemment consultés";
...
$GLOBAL['manageSegments']      = "Segments";
...
$GLOBAL['suivi']           = "Suivi";
$GLOBAL['sum']             = "Somme";
$GLOBAL['segmentName']        = "Nom du segment";
$GLOBAL['segmentCascadeRules']       = "Règles d'auto-assignation";
$GLOBAL['segmentCascadeRulesHint']   = "Ajouter un membre au segment source l'ajoute aussi automatiquement au segment cible.";
$GLOBAL['segmentCascadeSourceLabel'] = "Segment source…";
$GLOBAL['segmentCascadeTargetLabel'] = "Segment cible…";
$GLOBAL['cascadeRuleMissingTitle']  = "Règles d'auto-assignation non appliquées";
$GLOBAL['cascadeRuleMissingHelp']   = "Ces membres sont dans le segment source d'une règle mais pas encore dans le segment cible (assignation antérieure à la création de la règle, ou import contournant l'assignation individuelle).";
$GLOBAL['cascadeRuleSourceColumn']  = "Segment source";
$GLOBAL['cascadeRuleTargetColumn']  = "Segment cible";
$GLOBAL['cascadeRuleApplyFix']      = "Appliquer";
$GLOBAL['cotiSegmentMissingTitle']  = "Cotisants absents du segment de leur année";
$GLOBAL['cotiSegmentMissingHelp']   = "Ces membres ont payé une cotisation pour l'année indiquée mais ne sont pas dans le segment « Membre <année> » correspondant (entrée importée/rattrapée avant l'ajout automatique, ou retirés du segment depuis). Limité aux 3 dernières années.";
$GLOBAL['toggleSidebar']      = "Afficher/masquer le menu";
$GLOBAL['tasks']              = "Tâches";
$GLOBAL['tasksPageTitle']     = "Tâches";
$GLOBAL['taskTitle']          = "Titre";
$GLOBAL['taskAddNew']         = "Ajouter une tâche";
$GLOBAL['taskBody']           = "Description";
$GLOBAL['dueDate']            = "Échéance";
$GLOBAL['priority']           = "Priorité";
$GLOBAL['taskPriorityHigh']   = "Haute";
$GLOBAL['taskPriorityNormal'] = "Normale";
$GLOBAL['taskPriorityLow']    = "Basse";
$GLOBAL['taskOpen']           = "Ouverte";
$GLOBAL['taskDone']           = "Terminée";
$GLOBAL['taskOverdue']        = "En retard";
$GLOBAL['taskMarkDone']       = "Marquer comme terminée";
$GLOBAL['taskMarkDoneRecap']  = "Marquer comme notifié sans envoi d'email (écritures marquées notifiées)";
$GLOBAL['reopen']             = "Rouvrir";
$GLOBAL['noTasks']            = "Aucune tâche.";
$GLOBAL['noOpenTasks']        = "Aucune tâche ouverte.";
$GLOBAL['globalTask']         = "Tâche générale";
$GLOBAL['updateTask']         = "Mise à jour";
...
$GLOBAL['taskGenerateRecapBtn']    = "Générer les tâches de notification de versement";
$GLOBAL['taskRuleComptaRecapTitle'] = "Notification de versement %d en attente";
$GLOBAL['sendRecapBtnOne']         = "Envoyer la notification";
$GLOBAL['sendRecapSending']        = "Envoi…";
$GLOBAL['sendRecapConfirmOne']     = "Envoyer la notification de versement à %s ?";
$GLOBAL['sendRecapSentFail']       = "Échec de l'envoi";
$GLOBAL['taskCompletedTitle']      = "%d tâche(s) terminée(s)";
$GLOBAL['taskBulkDeleteBtn']       = "Supprimer les tâches terminées";
$GLOBAL['taskBulkDeleteConfirm']   = "Supprimer définitivement les %d tâche(s) terminée(s) ? Cette action est irréversible.";
$GLOBAL['taskBulkDeletedCount']    = "%d tâche(s) terminée(s) supprimée(s).";
$GLOBAL['taskPause']               = "Mettre en pause";
$GLOBAL['taskResume']              = "Reprendre";
$GLOBAL['taskPausedStatus']        = "En pause";
$GLOBAL['taskPausedTitle']         = "%d tâche(s) en pause";
...
$GLOBAL['taskRuleAttestationTitle']   = "Attestation de don %d à envoyer";
$GLOBAL['sendAttestationBtnOne']      = "Envoyer l'attestation";
$GLOBAL['sendAttestationSending']     = "Envoi…";
$GLOBAL['sendAttestationConfirmOne']  = "Envoyer l'attestation de dons à %s ?";
$GLOBAL['sendAttestationSentFail']    = "Échec de l'envoi";
$GLOBAL['dashboardPageTitle']      = "Tableau de bord";
$GLOBAL['dashboardTasksTitle']     = "Tâches à traiter";
$GLOBAL['dashboardOpenTaskCount']  = "%d tâche(s) ouverte(s)";
$GLOBAL['dashboardViewAllTasks']   = "Voir toutes les tâches";
$GLOBAL['dashboardKpiTitle']       = "En un coup d'œil";
$GLOBAL['dashboardShortcutsTitle'] = "Raccourcis";
$GLOBAL['dashboardRecentComptaTitle'] = "Dernières écritures";
...
$GLOBAL['dashboardShortcutAttestations'] = "Attestation à envoyer";
$GLOBAL['dashboardShortcutCurrentMembers'] = "Membres actuels";
$GLOBAL['dashboardToRelaunchSuffix'] = "à relancer";
$GLOBAL['dashboardUserGuideLink']  = "Guide utilisateur";
$GLOBAL['dashboardAdminGuideLink'] = "Guide administrateur";
$GLOBAL['peopleFinancePageTitle']  = "Contacts";
$GLOBAL['financesPageTitle'] = "Finances";
$GLOBAL['peopleFinanceTabMembers'] = "Contacts";
$GLOBAL['peopleFinanceMembersSubtitle'] = "Listes & segments";
$GLOBAL['filterBySegment'] = "Filtrer par segment";
$GLOBAL['viewAllCurrentMembers'] = "Voir tous les membres actuels";
$GLOBAL['peopleFinanceTabRecap']   = "Notification de versement";
$GLOBAL['peopleFinanceTabLapsed']  = "Mouvements membres";
$GLOBAL['peopleFinanceTabLapsedDonors'] = "Mouvements donateurs";
$GLOBAL['peopleFinanceTabDons']    = "Attestation";
$GLOBAL['peopleFinanceGroupFinances']  = "Finances";
$GLOBAL['peopleFinanceGroupEvolution'] = "Évolution";
$GLOBAL['adminGroupSegments']    = "Segments";
$GLOBAL['adminGroupApplication'] = "Application";
$GLOBAL['adminGroupDiagnostics'] = "Diagnostic";
$GLOBAL['peopleFinanceComingSoon'] = "Cette section n'est pas encore intégrée ici — elle vit encore sur sa propre page.";
$GLOBAL['peopleFinanceOpenLegacy'] = "Ouvrir";
$GLOBAL['dashboardComptaSearchLabel']       = "Chercher un contact pour ajouter une écriture compta";
$GLOBAL['dashboardComptaSearchPlaceholder'] = "Chercher un contact → Compta…";
$GLOBAL['dashboardComptaSearchNoResults']   = "Aucun résultat";
$GLOBAL['dashboardComptaSearchOneResult']   = "1 résultat";
$GLOBAL['dashboardComptaSearchResultsCount'] = "%d résultats";
$GLOBAL['tel']             = "Privé";
$GLOBAL['telProf']         = "Prof.";
$GLOBAL['title']           = "Titre";
$GLOBAL['total']           = "Total";
...
$GLOBAL['emailConsent']      = "Consentement à recevoir des e-mails";
...
$GLOBAL['contactTypeCodeBuiltinHelp'] = "Code fixe — utilisé par la suggestion de classement, non modifiable";
$GLOBAL['contactTypeCount']          = "Contacts";
$GLOBAL['contactTypeVisibleInAttestations']       = "Attestations";
$GLOBAL['contactTypeVisibleInAttestationsHelp']   = "Si coché, les contacts de ce type apparaissent dans la liste des attestations à envoyer (onglet Dons).";
$GLOBAL['contactTypeVisibleInAttestationsToggle'] = "Afficher les contacts « %s » dans la liste des attestations";
$GLOBAL['contactTypeVisibleInRecap']       = "Récapitulatif";
$GLOBAL['contactTypeVisibleInRecapHelp']   = "Si coché, les contacts de ce type apparaissent dans le récapitulatif compta (onglet Récapitulatif) et dans les tâches de notification liées.";
$GLOBAL['contactTypeVisibleInRecapToggle'] = "Afficher les contacts « %s » dans le récapitulatif";
$GLOBAL['contactTypeIcon']           = "Icône";
$GLOBAL['contactTypeIconPlaceholder'] = "ex. user";
$GLOBAL['contactTypeIconHelp']       = "Nom d'icône Font Awesome (sans le préfixe fa-), ex. \"user\", \"landmark\", \"building\".";
$GLOBAL['contactTypeIconFaHint']     = "Cherchez un nom d'icône libre sur %s et collez-le sans le préfixe « fa- ».";
$GLOBAL['newContactType']            = "Nouveau type de contact";
$GLOBAL['newContactTypeHelp']        = "Un type ajouté ici n'est jamais suggéré automatiquement par l'outil de classement ci-dessous — il ne sera assigné que manuellement, sur la fiche membre.";
$GLOBAL['contactTypeLabelSavedMsg']  = "Libellé enregistré.";
$GLOBAL['contactTypeFilterAll']      = "Tous les types de contact";
$GLOBAL['contactTypeMatrixTitle']    = "Types de compta autorisés par type de contact";
$GLOBAL['contactTypeMatrixHelp']     = "Restreint les types de compta proposés lors de la création d'une écriture, selon le type du contact. Tout coché (par défaut) = aucune restriction, tous les types actifs restent proposés.";
$GLOBAL['contactTypeMatrixSavedMsg'] = "Matrice enregistrée.";
$GLOBAL['contactTypeMatrixNoComptaTypes'] = "Aucun type de compta actif (non archivé) à configurer.";
...
$GLOBAL['oneSegmentHidden'] = "1 groupe masqué.";
$GLOBAL['segmentsHidden'] = "%d groupes masqués.";
$GLOBAL['oneSegmentShown'] = "1 groupe affiché.";
$GLOBAL['segmentsShown'] = "%d groupes affichés.";
$GLOBAL['lapsedDonorsSegmentName'] = "Donateurs à relancer %d (%s)";
$GLOBAL['lapsedMembersSegmentName'] = "Membres à relancer %d (%s)";
$GLOBAL['noUsersToAdd'] = "Aucun utilisateur à ajouter.";
$GLOBAL['invalidData'] = "Données invalides";
$GLOBAL['segmentNotFound'] = "Groupe introuvable";
...
$GLOBAL['backToMemberOverview'] = "Retour aux membres et finances";
$GLOBAL['newMembersTitle'] = "Nouveaux membres %d";
$GLOBAL['newMembersCount'] = "<strong>%s nouveau%s membre(s)</strong> — cotisation payée en <strong>%d</strong> sans cotisation en <strong>%d</strong>.";
$GLOBAL['newMembers'] = "Nouveaux membres";
...
$GLOBAL['filterBulkCount']         = "%d personne(s) dans ce filtre.";
$GLOBAL['filterCreateSegmentBtn']  = "Créer un segment";
$GLOBAL['filterAddToSegmentBtn']   = "Ajouter à un segment existant";
$GLOBAL['filterArchiveBtn']        = "Archiver en masse";
$GLOBAL['confirmCreateFilterSegment'] = "Créer un segment avec ces <strong>%d</strong> personne(s) ?";
$GLOBAL['confirmAddFilterToSegment']  = "Ajouter ces <strong>%d</strong> personne(s) au segment choisi :";
$GLOBAL['chooseSegment']              = "Choisir un segment…";
$GLOBAL['filterArchiveWarning']    = "Action en masse : ces membres seront archivés (statut inactif). C'est réversible (réactivation possible un par un), mais vérifiez la liste avant de continuer.";
$GLOBAL['confirmArchiveFilterUsers']    = "Archiver ces <strong>%d</strong> membre(s) ?";
$GLOBAL['neverPaidSegmentName']       = "Jamais versé — %s";
$GLOBAL['noActivity10ySegmentName']   = "Aucune activité 10 ans — %s";
$GLOBAL['cotiReminderConfirmOne']   = "Envoyer un rappel de cotisation à %s ?";
...
$GLOBAL['cotiReminderResendBtn']     = "Renvoyer";
$GLOBAL['cotiReminderResendConfirm'] = "Un rappel a déjà été envoyé à %s le %s. Envoyer quand même ?";
...
$GLOBAL['gapToBudget'] = "Il manque %s CHF pour atteindre le budget %d (%s) — %s%% atteint";
$GLOBAL['budgetExceeded'] = "Budget %d (%s) dépassé de +%s CHF (+%s%%)";
$GLOBAL['budgetsPageTitle'] = "Budgets";
$GLOBAL['budgetsHelp'] = "Un budget par type de comptabilité et par année (année passée, en cours, prochaine). Les montants s'enregistrent automatiquement.";
$GLOBAL['budgetsDonationTitle'] = "Types comptant dans les dons";
$GLOBAL['budgetsDonationHelp'] = "Ces types alimentent le budget comparé au KPI « Contributions » du tableau de bord.";
$GLOBAL['budgetsExcludedTitle'] = "Types exclus des dons";
$GLOBAL['budgetsExcludedHelp'] = "Ces types (ex. cotisations) alimentent le budget comparé au KPI « Membres » du tableau de bord.";
$GLOBAL['budgetsNoTypes'] = "Aucun type dans cette catégorie.";
$GLOBAL['budgetColYear'] = "Budget %d";
$GLOBAL['budgetColCollected'] = "Collecté %d";
$GLOBAL['budgetInputLabel'] = "Budget %s pour %d";
$GLOBAL['budgetSavedMsg'] = "Enregistré";
$GLOBAL['excludedFromDonationShort'] = "exclu des dons";
...
$GLOBAL['includeStampSignature'] = "Inclure tampon/signature";
$GLOBAL['sendAttestationBtn'] = "Envoyer l'attestation par email";
$GLOBAL['sendAttestationConfirm'] = "Envoyer l'attestation de dons %d de %s par email ?";
$GLOBAL['sendAllAttestationsEmail'] = "Envoyer par email";
$GLOBAL['downloadAllAttestationsPdf'] = "PDF";
$GLOBAL['sendBtn'] = "Envoyer";
$GLOBAL['bulkAttestSendConfirmBody'] = "Envoyer par email l'attestation de dons à %s personne(s) ayant une adresse email.";
$GLOBAL['bulkAttestSendInProgress'] = "Envoi en cours…";
$GLOBAL['sendAttestationsBulkOk'] = "%d attestation(s) envoyée(s), %sk ignorée(s) (pas d'email ou échec), %alr déjà envoyée(s) (non renvoyée(s)).";
$GLOBAL['sendBccCopyLabel'] = "Envoyer une copie (BCC) à %s";
$GLOBAL['bulkAttestAlreadySentIntro'] = "personne(s) ont déjà reçu leur attestation cette année — cochez pour renvoyer (sinon ignoré) :";
$GLOBAL['sendAttestationsBulkFail'] = "Échec de l'envoi des attestations.";
$GLOBAL['downloadAllAttestationsPdfStamped'] = "PDF avec tampon/signature";
$GLOBAL['attestationOffSeasonWarning'] = "L'envoi des attestations se fait normalement en janvier. Nous ne sommes pas en janvier.";
$GLOBAL['attestationOffSeasonConfirm'] = "Je confirme vouloir envoyer une attestation hors de la période habituelle.";
...
$GLOBAL['cotisantsImportNoYearSelected'] = "Aucune année sélectionnée — rien n'a été importé.";
$GLOBAL['donorsImported'] = "Donateurs importés dans le segment.";
$GLOBAL['donorsImportNoTypeSelected'] = "Aucun type de don sélectionné — rien n'a été importé. Cochez « Tous les types » ou au moins un type.";
$GLOBAL['donorsImportNoYearSelected'] = "Aucune année sélectionnée — rien n'a été importé. Cochez « Toutes les années » ou au moins une année.";
...
$GLOBAL['allDonorTypes'] = "Tous les types";
$GLOBAL['allYears'] = "Toutes les années";
$GLOBAL['noneSelected'] = "Aucun sélectionné";
$GLOBAL['typesSelected'] = "types sélectionnés";
$GLOBAL['yearsSelected'] = "années sélectionnées";
...
$GLOBAL['orgFinanceSectionTitle'] = "Finances";
$GLOBAL['orgMembershipSectionTitle'] = "Adhésion";
$GLOBAL['orgName'] = "Nom de l'organisation";
$GLOBAL['npaShort'] = "NPA";
$GLOBAL['memberSegmentPrefixLabel'] = "Préfixe des segments membres";
$GLOBAL['memberSegmentPrefixHelp'] = "Préfixe utilisé pour retrouver les segments membres des années précédentes (ex: «Membre» pour les segments «Membre 2025», «Membre 2026»…).";
...
$GLOBAL['defaultSegmentLabel'] = "Segment affiché par défaut";
$GLOBAL['defaultSegmentHelp'] = "Segment sélectionné à l'ouverture de la liste des membres. Choisir le segment correspondant aux membres de l'année en cours (ex: «Membre 2026»). À mettre à jour chaque année.";
$GLOBAL['maskedSuffix'] = "(masqué)";
$GLOBAL['membreSegmentLabel'] = "Segment membres (année de référence)";
$GLOBAL['membreSegmentHelp'] = "Segment membres de l'année en cours (ex: «Membre 2026»). Utilisé pour les filtres cotisations et affiché dans le tableau de bord Contributions avec comparaison à l'année précédente. À mettre à jour chaque année.";
$GLOBAL['noCotiSegmentLabel'] = "Segment membres sans cotisation";
$GLOBAL['noCotiSegmentHelp'] = "Membres considérés comme actifs sans payer de cotisation (bénévoles, comité…). Exclus du filtre «Aucune cotisation ces 3 dernières années». Laisser vide si non applicable.";
...
$GLOBAL['orgTaxStatusHelp'] = "Ex. : «Exonérée d'impôts AFC-GE depuis 2018». Saisie manuelle — aucun registre fédéral ne l'expose pour l'instant.";
$GLOBAL['orgTaxStatusPlaceholder'] = "Ex. : Exonérée AFC-GE depuis 2018";
$GLOBAL['orgIban'] = "IBAN";
$GLOBAL['orgIbanHelp'] = "Numéro IBAN de l'association. Utilisé pour les bulletins de versement QR.";
$GLOBAL['orgCotiAmountDesc'] = "Description du montant (rappels de cotisation)";
$GLOBAL['orgCotiAmountDescHelp'] = "Texte affiché dans l'email de rappel et sur le bulletin QR (champ «Montant»). Laissez vide pour utiliser la valeur par défaut.";
$GLOBAL['orgCotiAmountDescPlaceholder'] = "min. CHF 50.- / pers. · CHF 80.- / famille · CHF 20.- étudiant·e·s, AVS, chômeur·euse·s";
...
// --- settings_filters ---
$GLOBAL['filtersHelp'] = "Créez une vue rapide en cochant plusieurs segments à combiner. Exemple : un segment combiné « Membres Genève + Vaud » regroupe deux segments régionaux en un seul raccourci dans la barre de navigation — toujours à jour, sans copie de données.";
...
$GLOBAL['membersSameSociety'] = "Contacts avec la même entreprise";
...
$GLOBAL['defaultLibeleField'] = "Libellé par défaut";
$GLOBAL['defaultLibeleHelp'] = "Pré-rempli dans le formulaire de saisie des écritures. Pour un type cotisation, l'année sélectionnée est ajoutée automatiquement (ex. « Cotisation 2026 »).";
...
$GLOBAL['financialInstTooltip'] = "Versement d'un établissement financier";
$GLOBAL['financialInstShort'] = "Étab. fin.";
$GLOBAL['companyTypeTooltip'] = "Versement d'une entreprise";
$GLOBAL['companyTypeShort'] = "Entr.";
$GLOBAL['archivedTooltip'] = "Type archivé — masqué du choix lors de la création d'une nouvelle écriture, reste visible sur les écritures existantes";
$GLOBAL['archivedShort'] = "Archivé";
...
$GLOBAL['deleteContactTypeTitle'] = "Supprimer ce type de contact";
$GLOBAL['deleteContactTypeConfirm'] = "Supprimer ce type de contact ? Cette action est irréversible.";
...
$GLOBAL['deletionEligibleLabel'] = "Éligible à la suppression";
$GLOBAL['deletionBlockedBadge'] = "Données comptables";
$GLOBAL['bulkDeleteBtn'] = "Supprimer";
...
$GLOBAL['filterDescNonInstit5y'] = "Contacts non institutionnels ayant effectué au moins un versement non institutionnel depuis le 1er janvier %s.";
$GLOBAL['filterDescCotiPaid6y'] = "Contacts ayant payé au moins une cotisation depuis le 1er janvier %s.";
...
$GLOBAL['dtInfoProfiles'] = "_TOTAL_ contacts";
...
$GLOBAL['loadError'] = "Erreur de chargement.";
...
$GLOBAL['npaLabel'] = "NPA";
$GLOBAL['memberPrefixLabel'] = "Préfixe des segments membres";
...
$GLOBAL['myProfileTitle'] = "Mon profil";
$GLOBAL['myAccountLabel'] = "Mon compte";
...
$GLOBAL['appBaseUrl']          = "URL publique de l'application";
$GLOBAL['appBaseUrlHelp']      = "Optionnel. Utilisée pour transformer les liens d'action dans les emails (ex. digest de tâches) en liens cliquables vers l'application. Sans cette URL, les emails restent en texte simple. Exemple : https://membres.mon-asso.ch";
...
$GLOBAL['notFound'] = "Introuvable.";
$GLOBAL['emailViewPlaintext']    = "Voir la version texte brut";
$GLOBAL['regenerateAttestationBtn'] = "Régénérer l'attestation (PDF)";
...
$GLOBAL['comptaRecapScopeAll']       = "Inclure les versements déjà notifiés";
